...
$plugin_tx['foldergallery']['syscheck_extension']="die PHP-Extension '%s' geladen wurde";
$plugin_tx['foldergallery']['syscheck_fail']="Fehlschlag";
$plugin_tx['foldergallery']['syscheck_message']="Prüfe, dass %1\$s … %2\$s";
$plugin_tx['foldergallery']['syscheck_phpversion']="die PHP-Version mindestens %s ist";
$plugin_tx['foldergallery']['syscheck_plugin']="das CMSimple_XH-Plugin '%s' installiert ist";
...
$plugin_tx['foldergallery']['syscheck_xhversion']="die CMSimple_XH-Version mindestens %s ist";
